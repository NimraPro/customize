...
class App extends React.Component<IAppProps, IAppState> {
  ...
  constructor(props: IAppProps) {
    ...
    this.state = {
      ...
      selectedEmployee: "",
      familyName: "",
      fullName: "Nimra CivoTemha",
      fullNameSlug: "nimra-civo",
      givenName: "Nimra CivoTemha",
      hidePicture: false,
      hideAwareLogo: false,
      hideAddress: false,
      ...
      secondaryTitle: "",
      linkedinUrl: "https://www.lll.com/",
      sameLinePhoneNumbers: true,
      workplaceUrl: "https://nimra.cloud",
      profilePicture: "https://wiretapfiles.box.com/shared/static/81nuynta2p10mbvg0kksiy8pa18qv140.png",
      companyLogoUrl: "https://softr-prod.imgix.net/applications/d9ad27cb-5d54-4b92-b3b2-b8002acb2778/assets/c068a00d-78bf-4093-9491-35d605c97e38.png",
      companyLogoWidth: 128,
      companyLogoHeight: 128,
      companyName: "Nimra.cloud",
